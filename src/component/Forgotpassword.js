    ...
    <>
      <div className="body">
        <div className="iner-body">
          ...
          <h1 className="text-center fs-2 pt-3">Forgotten Password?</h1>
          <p className="text-center fs-6">Please enter your email so we can send you a verification code</p>
          </div>
          ...
          <form className="w-100 p-3  mx-auto" action="">
           ...
           <div className="w-100  d-flex justiify-content-center align-items-center  mt-3">
             <div onClick={sendemail} className="text-center btn btn-dark  mt-2 email-but"> Send Email</div>
           </div>
          </form>
           </div>
        </div>
